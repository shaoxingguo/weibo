...
extension XGStatusDAL
{
    ...
    open class func loadAdvertisementData(completion:@escaping ([String:Any]?, Error?) -> Void) -> Void
    {
...
extension XGStatusDAL
{
    ...
    ///   - code: 授权码
    ///   - completion: 完成回调
    open class func loadAccessToken(code:String,completion:@escaping ([String:Any]?,Error?) -> Void) -> Void
    {
        ...
        XGNetworkManager.request(type: .Post, URLString: kAccessTokenAPI, parameters: parameters) { (responseObject, error) in
            if error != nil || responseObject == nil {
                ...
                if  var responseObject = responseObject as? [String:Any],
                    ...
                    loadUserInfo(userId: uid, accessToken: accessToken, completion: { (userInfo, error) in
...
extension XGStatusDAL
{
    ...
    ///   - completion: 完成回调
    open class func loadStatusList(sinceId:Int64 = 0,maxId:Int64 = 0,completion:@escaping ([[String:Any]]?,Error?) -> Void) -> Void
    {
    ...
    ///
    /// - Parameter completion: 完成回调
    open class func loadEmotionsList(completion:@escaping ([[String:Any]]?,Error?) ->Void) -> Void
    {
